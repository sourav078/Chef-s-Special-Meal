...
?>
<h3 style="text-align: left;padding:12px;">Welcome Chef <?php $name = fetch_all_data_usingDB($db,"select * from user where id= '".$_SESSION['user_id']."'"); echo $name['name'];  ?></h3>
        ...
        <div class="row">
            ...
            <div class="col-md-6">
                <div style="margin-left:60%;">
                    <a href="food_add.php" class="btn btn-success" style="min-width: 150px;"><i class="fa fa-plus-circle" aria-hidden="true"></i> &nbsp;Add Food Post</a>
