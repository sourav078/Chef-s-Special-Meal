...
?>
<h3 style="text-align: left;padding:12px;">Welcome <?php $name = fetch_all_data_usingDB($db,"select * from user where id= '".$_SESSION['user_id']."'"); echo $name['name'];  ?></h3>
<section>
    <div class="container mt-5 mb-5">
        <div class="row">
            <div class="col-md-12">
                <h1 class="text-center">Food Posts</h1>
            </div>
        </div>
